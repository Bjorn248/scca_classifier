...
const carFlags = {
  ...
  'itrCar': [
    'itrLandingPage',
    'improvedtouringitrEngine',
    'improvedtouringitrRotaryEngine',
    'improvedtouringitrTurboEngine',
    'improvedtouringitrCooling',
    'improvedtouringitrDrivetrain',
    'improvedtouringitrSuspension',
    'improvedtouringitrBrakes',
    'improvedtouringitrWheels',
    'improvedtouringitrBodywork',
    'improvedtouringitrInterior',
    'improvedtouringitrElectrical',
    'improvedtouringitrSafety',
    'improvedtouringitrMeasurement',
  ],
  'itsCar': [
    'itsLandingPage',
    'improvedtouringitsEngine',
    'improvedtouringitsRotaryEngine',
    'improvedtouringitsTurboEngine',
    'improvedtouringitsCooling',
    'improvedtouringitsDrivetrain',
    'improvedtouringitsSuspension',
    'improvedtouringitsBrakes',
    'improvedtouringitsWheels',
    'improvedtouringitsBodywork',
    'improvedtouringitsInterior',
    'improvedtouringitsElectrical',
    'improvedtouringitsSafety',
    'improvedtouringitsMeasurement',
  ],
  'itaCar': [
    'itaLandingPage',
    'improvedtouringitaEngine',
    'improvedtouringitaRotaryEngine',
    'improvedtouringitaTurboEngine',
    'improvedtouringitaCooling',
    'improvedtouringitaDrivetrain',
    'improvedtouringitaSuspension',
    'improvedtouringitaBrakes',
    'improvedtouringitaWheels',
    'improvedtouringitaBodywork',
    'improvedtouringitaInterior',
    'improvedtouringitaElectrical',
    'improvedtouringitaSafety',
    'improvedtouringitaMeasurement',
  ],
  'itbCar': [
    'itbLandingPage',
    'improvedtouringitbEngine',
    'improvedtouringitbRotaryEngine',
    'improvedtouringitbTurboEngine',
    'improvedtouringitbCooling',
    'improvedtouringitbDrivetrain',
    'improvedtouringitbSuspension',
    'improvedtouringitbBrakes',
    'improvedtouringitbWheels',
    'improvedtouringitbBodywork',
    'improvedtouringitbInterior',
    'improvedtouringitbElectrical',
    'improvedtouringitbSafety',
    'improvedtouringitbMeasurement',
  ],
  'itcCar': [
    'itcLandingPage',
    'improvedtouringitcEngine',
    'improvedtouringitcRotaryEngine',
    'improvedtouringitcTurboEngine',
    'improvedtouringitcCooling',
    'improvedtouringitcDrivetrain',
    'improvedtouringitcSuspension',
    'improvedtouringitcBrakes',
    'improvedtouringitcWheels',
    'improvedtouringitcBodywork',
    'improvedtouringitcInterior',
    'improvedtouringitcElectrical',
    'improvedtouringitcSafety',
    'improvedtouringitcMeasurement',
  ],
  'asCar': [
    'asLandingPage',
    'americansedanEngine',
    'americansedanCooling',
    'americansedanDrivetrain',
    'americansedanSuspension',
    'americansedanBrakes',
    'americansedanWheels',
    'americansedanBodywork',
    'americansedanInterior',
    'americansedanSafety',
    'americansedanMisc',
  ],
  't1Car': [
  ...
  't2t4Car': [
    ...
    'touringt2t4Engine',
    'touringt2t4Cooling',
    'touringt2t4Drivetrain',
    'touringt2t4Suspension',
    'touringt2t4Brakes',
    'touringt2t4Wheels',
    'touringt2t4Bodywork',
    'touringt2t4Interior',
  ...
  'prodCar': [
    'prodLandingPage',
    'productionDrivetrain',
    'productionSuspension',
    'productionCooling',
    'productionBrakes',
    'productionWheels',
    'productionBodywork',
  ...
  'stuCar': [
    'stuLandingPage',
    'supertouringstuChassisBodywork',
    'supertouringstuEngines',
    'supertouringstuDrivetrain',
    'supertouringstuSuspension',
    'supertouringstuBrakes',
    'supertouringstuWheels',
    'supertouringstuTires',
    'supertouringstuWeights',
  ],
  'stlCar': [
    'stlLandingPage',
    'supertouringstlChassis',
    'supertouringstlEngines',
    'supertouringstlDrivetrain',
    'supertouringstlSuspension',
    'supertouringstlBrakes',
    'supertouringstlWheels',
    'supertouringstlTires',
    'supertouringstlWeightReq',
    'supertouringstlAllowances',
  ],
  'gtCar': [
    'gtLandingPage',
    'gtEngine',
...
const allSoloCars = {
  ...
  'Acura': {
    ...
    'Integra (all except Type R)': {
      ...
      '2022': ['hs', 'gst', 'sm', 'smf', 'xa', 'xp'],
      '2023': ['hs', 'gst', 'sm', 'smf', 'xa', 'xp'],
      '2024': ['hs', 'gst', 'sm', 'smf', 'xa', 'xp'],
      '2025': ['hs', 'gst', 'sm', 'smf', 'xa', 'xp'],
    },
    'Integra Type R': {
  ...
  'Aston Martin': {
    'V8 Vantage': {
      ...
      '2018': ['as', 'sst', 'sm', 'xp', 'xu'],
      '2019': ['as', 'sst', 'sm', 'xp', 'xu'],
      '2020': ['as', 'sst', 'sm', 'xp', 'xu'],
      '2021': ['as', 'sst', 'sm', 'xp', 'xu'],
      '2022': ['as', 'sst', 'sm', 'xp', 'xu'],
      '2023': ['as', 'sst', 'sm', 'xp', 'xu'],
    },
  },
  'Audi': {
    '80': {
  ...
  'BMW': {
    '315': {
      '1981': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
      '1982': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
      '1983': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
    },
    '316': {
    ...
    '3 Series (non-M3, non-turbo)': {
      ...
      '1984': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1985': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1986': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1987': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1988': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1989': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1990': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1991': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1992': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1993': ['hs', 'dst', 'esp', 'sm', 'dp', 'xp', 'xa'],
      '1994': ['hs', 'dst', 'esp', 'sm', 'xp', 'xa'],
      '1995': ['hs', 'dst', 'esp', 'sm', 'xp', 'xa'],
      '1996': ['hs', 'dst', 'esp', 'sm', 'xp', 'xa'],
      '1997': ['hs', 'dst', 'esp', 'sm', 'xp', 'xa'],
      '1998': ['hs', 'dst', 'esp', 'sm', 'xp', 'xa'],
      '1999': ['hs', 'dst', 'esp', 'sm', 'xp', 'xa'],
      '2000': ['hs', 'dst', 'esp', 'sm', 'xp', 'xa'],
      '2001': ['hs', 'dst', 'esp', 'sm', 'xp', 'xa'],
      '2002': ['hs', 'dst', 'esp', 'sm', 'xp', 'xa'],
    ...
    '318i': {
      '1975': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
      '1976': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
      '1977': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
      '1978': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
      '1979': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
      '1980': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
    },
    ...
    '320/6': {
      '1977': ['hs', 'dst', 'fsp', 'sm', 'xp', 'xb'],
      '1978': ['hs', 'dst', 'fsp', 'sm', 'xp', 'xb'],
      '1979': ['hs', 'dst', 'fsp', 'sm', 'xp', 'xb'],
      '1980': ['hs', 'dst', 'fsp', 'sm', 'xp', 'xb'],
      '1981': ['hs', 'dst', 'fsp', 'sm', 'xp', 'xb'],
      '1982': ['hs', 'dst', 'fsp', 'sm', 'xp', 'xb'],
    },
    '320i': {
      '1975': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
      '1976': ['hs', 'dst', 'fsp', 'sm', 'dp', 'xp', 'xb'],
    ...
    'Z4 M40i (6-cyl)': {
      '2019': ['bs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2020': ['bs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2021': ['bs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2022': ['bs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2023': ['bs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2024': ['bs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2025': ['bs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2026': ['bs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
    },
    'Z4 M Coupe & Roadster': {
    ...
    'Z4 sDrive 30i (4-cyl)': {
      '2019': ['cs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2020': ['cs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2021': ['cs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2022': ['cs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2023': ['cs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2024': ['cs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2025': ['cs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
      '2026': ['cs', 'sst', 'ssp', 'ssm', 'xp', 'xa'],
    },
    'Z8': {
  ...
  'Chevrolet': {
    ...
    'Cobalt SS (2.0L SC)': {
      '2005': ['hs', 'dst', 'esp', 'xp', 'xa', 'sm', 'smf'],
      '2006': ['hs', 'dst', 'esp', 'xp', 'xa', 'sm', 'smf'],
      '2007': ['hs', 'dst', 'esp', 'xp', 'xa', 'sm', 'smf'],
    },
    'Cobalt SS (2.0L Turbo)': {
      '2008': ['gs', 'gst', 'esp', 'xp', 'xa', 'sm', 'smf'],
      '2009': ['gs', 'gst', 'esp', 'xp', 'xa', 'sm', 'smf'],
      '2010': ['gs', 'gst', 'esp', 'xp', 'xa', 'sm', 'smf'],
    },
  ...
  'Chrysler': {
    ...
    '300 (V6)': {
      '2004': ['hs', 'camc', 'xp', 'sm'],
      '2005': ['hs', 'camc', 'xp', 'sm'],
      '2006': ['cp', 'hs', 'camc', 'xp', 'sm'],
      '2007': ['cp', 'hs', 'camc', 'xp', 'sm'],
      '2008': ['cp', 'hs', 'camc', 'xp', 'sm'],
      '2009': ['cp', 'hs', 'camc', 'xp', 'sm'],
      '2010': ['cp', 'hs', 'camc', 'xp', 'sm'],
  ...
  'Ford': {
    ...
    'Focus ST': {
      ...
      '2014': ['hs', 'gst', 'esp', 'sm', 'xp', 'xa'],
      '2015': ['hs', 'gst', 'esp', 'sm', 'xp', 'xa'],
      '2016': ['hs', 'gst', 'esp', 'sm', 'xp', 'xa'],
      '2017': ['hs', 'gst', 'esp', 'sm', 'xp', 'xa'],
      '2018': ['hs', 'gst', 'esp', 'sm', 'xp', 'xa'],
    },
    'Fusion': {
    ...
    'Mustang GT': {
      ...
      '2006': ['fs', 'csm', 'sm', 'camc', 'xp'],
      '2007': ['fs', 'csm', 'sm', 'camc', 'xp'],
      '2008': ['fs', 'csm', 'sm', 'camc', 'xp'],
      '2009': ['fs', 'csm', 'sm', 'camc', 'xp'],
      '2010': ['fs', 'camc', 'sm', 'xp'],
      '2011': ['fs', 'camc', 'sm', 'xp'],
      '2012': ['fs', 'camc', 'sm', 'xp'],
      '2013': ['fs', 'camc', 'sm', 'xp'],
    ...
    'Mustang GT (excl. Shelby and Boss 302)': {
      '2005': ['fs', 'bst', 'csm', 'camc', 'sm', 'xp'],
      '2006': ['fs', 'bst', 'csm', 'camc', 'sm', 'xp'],
      '2007': ['fs', 'bst', 'csm', 'camc', 'sm', 'xp'],
      '2008': ['fs', 'bst', 'csm', 'camc', 'sm', 'xp'],
      '2009': ['fs', 'bst', 'csm', 'camc', 'sm', 'xp'],
      '2010': ['fs', 'bst', 'camc', 'sm', 'xp'],
      '2011': ['fs', 'bst', 'camc', 'sm', 'xp'],
      '2012': ['fs', 'bst', 'camc', 'sm', 'xp'],
      '2013': ['fs', 'bst', 'camc', 'sm', 'xp'],
      '2014': ['fs', 'bst', 'camc', 'sm', 'xp'],
      '2015': ['fs', 'bst', 'esp', 'camc', 'sm', 'xp'],
      '2016': ['fs', 'bst', 'esp', 'camc', 'sm', 'xp'],
      '2017': ['fs', 'bst', 'esp', 'camc', 'sm', 'xp'],
  ...
  'Honda': {
    ...
    'CRX': {
      ...
      '1986': ['hs', 'est', 'fsp', 'smf', 'ep', 'xb'],
      '1987': ['hs', 'est', 'fsp', 'smf', 'ep', 'xb'],
      '1988': ['hs', 'est', 'dsp', 'smf', 'ep', 'xb'],
      '1989': ['hs', 'est', 'dsp', 'smf', 'ep', 'xb'],
      '1990': ['hs', 'est', 'dsp', 'smf', 'ep', 'xb'],
      '1991': ['hs', 'est', 'dsp', 'smf', 'ep', 'xb'],
    },
    'Civic': {
    ...
    'Civic Type R': {
      ...
      '2025': ['bs', 'bst', 'dsp', 'smf', 'ep', 'xa'],
    },
    'Civic Type R Limited Edition': {
      '2021': ['bs', 'bst', 'dsp', 'smf', 'ep', 'xa'],
    },
    'Fit': {
      '2007': ['hs', 'est', 'fsp', 'smf', 'ep', 'xa'],
      '2008': ['hs', 'est', 'fsp', 'smf', 'ep', 'xa'],
    ...
    'S2000 (non-CR)': {
      ...
      '2001': ['cs', 'cst', 'dsp', 'ssm', 'fp', 'xa'],
      '2002': ['cs', 'cst', 'dsp', 'ssm', 'fp', 'xa'],
      '2003': ['cs', 'cst', 'dsp', 'ssm', 'fp', 'xa'],
      '2004': ['cs', 'cst', 'dsp', 'ssm', 'fp', 'xa'],
      '2005': ['cs', 'cst', 'dsp', 'ssm', 'fp', 'xa'],
      '2006': ['cs', 'cst', 'dsp', 'ssm', 'fp', 'xa'],
      '2007': ['cs', 'cst', 'dsp', 'ssm', 'fp', 'xa'],
      '2008': ['cs', 'cst', 'dsp', 'ssm', 'fp', 'xa'],
      '2009': ['cs', 'cst', 'dsp', 'ssm', 'fp', 'xa'],
    },
    'S2000 CR': {
      '2008': ['as', 'ast', 'dsp', 'ssm', 'fp', 'xa'],
      '2009': ['as', 'ast', 'dsp', 'ssm', 'fp', 'xa'],
    },
    'del Sol (DOHC)': {
  ...
  'Hyundai': {
    ...
    'Elantra N': {
      '2022': ['gs', 'sm', 'xp', 'xa', 'smf'],
      '2023': ['gs', 'sm', 'xp', 'xa', 'smf'],
      '2024': ['gs', 'sm', 'xp', 'xa', 'smf'],
      '2025': ['gs', 'sm', 'xp', 'xa', 'smf'],
    },
    'Excel': {
    ...
    'Genesis Coupe (4-cyl Turbo)': {
      '2010': ['hs', 'gst', 'sm', 'xp', 'xa'],
      '2011': ['hs', 'gst', 'sm', 'xp', 'xa'],
      '2012': ['hs', 'gst', 'sm', 'xp', 'xa'],
    ...
    'Veloster N': {
      '2019': ['gs', 'bst', 'sm', 'xp', 'xa', 'smf'],
      '2020': ['gs', 'bst', 'sm', 'xp', 'xa', 'smf'],
      '2021': ['gs', 'bst', 'sm', 'xp', 'xa', 'smf'],
      '2022': ['gs', 'bst', 'sm', 'xp', 'xa', 'smf'],
    },
    'Veloster Turbo': {
  ...
  'Lexus': {
    ...
    'IS 300': {
      ...
      '2001': ['esp', 'dst', 'hs', 'fp', 'xp', 'xa', 'sm'],
      '2002': ['esp', 'dst', 'hs', 'fp', 'xp', 'xa', 'sm'],
      '2003': ['esp', 'dst', 'hs', 'fp', 'xp', 'xa', 'sm'],
      '2004': ['esp', 'dst', 'hs', 'fp', 'xp', 'xa', 'sm'],
      '2005': ['esp', 'dst', 'hs', 'fp', 'xp', 'xa', 'sm'],
  ...
  'Mazda': {
    ...
    'MX-5 Miata': {
      '1990': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
      '1991': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
      '1992': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
      '1993': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
      '1994': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '1995': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '1996': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '1997': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '1998': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '1999': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '2000': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '2001': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '2002': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '2003': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '2004': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '2005': ['es', 'cst', 'dsp', 'ssm', 'dp', 'xb'],
      '2006': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2007': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2008': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2009': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2010': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2011': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2012': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2013': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2014': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2015': ['cs', 'cst', 'csx', 'dsp', 'ssm', 'dp', 'xb'],
      '2016': ['cs', 'ast', 'dsp', 'ssm', 'dp', 'xb'],
      '2017': ['cs', 'ast', 'dsp', 'ssm', 'dp', 'xb'],
      '2018': ['cs', 'ast', 'dsp', 'ssm', 'dp', 'xb'],
      '2019': ['cs', 'ast', 'dsp', 'ssm', 'dp', 'xb'],
      '2020': ['cs', 'ast', 'dsp', 'dp', 'ssm', 'xb'],
      '2021': ['cs', 'ast', 'dsp', 'dp', 'ssm', 'xb'],
      '2022': ['cs', 'ast', 'dsp', 'dp', 'ssm', 'xb'],
      '2023': ['cs', 'ast', 'dsp', 'dp', 'ssm', 'xb'],
      '2024': ['cs', 'ast', 'dsp', 'dp', 'ssm', 'xb'],
      '2025': ['cs', 'ast', 'dsp', 'dp', 'ssm', 'xb'],
    },
    'MX-5 Miata First Generation (NA) non-Torsen differential': {
      ...
      '1992': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
      '1993': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
      '1994': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
      '1995': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
      '1996': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
      '1997': ['es', 'est', 'dsp', 'ssm', 'dp', 'xb'],
    },
    'MX-5 Miata MS-R': {
      '2007': ['bs', 'ssm', 'xb', 'xp'],
    },
    ...
    'Mazda3 Turbo': {
      '2021': ['gs', 'gst', 'xp', 'xa', 'sm'],
      '2022': ['gs', 'gst', 'xp', 'xa', 'sm'],
      '2023': ['gs', 'gst', 'xp', 'xa', 'sm'],
      '2024': ['gs', 'gst', 'xp', 'xa', 'sm'],
      '2025': ['gs', 'gst', 'xp', 'xa', 'sm'],
    },
    'Mazda6 (non-turbo)': {
      'all': ['hs', 'est', 'dsp', 'xp', 'xa', 'sm', 'smf'],
    },
    'Mazda 6 (turbo, non-Mazdaspeed)': {
      'all': ['hs', 'gst', 'dsp', 'xp', 'xa', 'sm', 'smf'],
    },
    'Mazdaspeed3': {
      'all': ['hs', 'gst', 'dsp', 'xp', 'xa', 'sm', 'smf'],
    },
    ...
    'Mazdaspeed Miata': {
      '2004': ['es', 'ast', 'dsp', 'ssm', 'fp', 'xb'],
      '2005': ['es', 'ast', 'dsp', 'ssm', 'fp', 'xb'],
    },
    'Mazdaspeed Protégé': {
      'all': ['hs', 'gst', 'dsp', 'fp', 'xp', 'xa', 'sm', 'smf'],
    },
    'Miata Club Sport': {
  ...
  'Mercedes': {
    ...
    '190 (all, non-16v)': {
      '1984': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
      '1985': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
      '1986': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
      '1987': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
      '1988': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
      '1989': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
      '1990': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
      '1991': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
      '1992': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
      '1993': ['hs', 'esp', 'dp', 'xp', 'xa', 'sm'],
    },
    '190E (16v)': {
      '1983': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1984': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1985': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1986': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1987': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1988': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1989': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1990': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1991': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1992': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
      '1993': ['hs', 'csp', 'dp', 'xp', 'xa', 'sm'],
    },
    ...
    'C230': {
      '1999': ['hs', 'dsp', 'xp', 'xa', 'sm'],
      '2000': ['hs', 'dsp', 'xp', 'xa', 'sm'],
      '2001': ['hs', 'dsp', 'xp', 'xa', 'sm'],
      '2002': ['hs', 'dsp', 'xp', 'xa', 'sm'],
      '2003': ['hs', 'dsp', 'xp', 'xa', 'sm'],
      '2004': ['hs', 'dsp', 'xp', 'xa', 'sm'],
      '2005': ['hs', 'dsp', 'xp', 'xa', 'sm'],
      '2006': ['hs', 'dsp', 'xp', 'xa', 'sm'],
      '2007': ['hs', 'dsp', 'xp', 'xa', 'sm'],
    },
    'C250': {
  ...
  'Mini': {
    ...
    'Cooper Clubman (non-S, non-JCW)': {
      ...
      '2018': ['hs', 'xp', 'xa', 'sm', 'smf'],
      '2019': ['hs', 'xp', 'xa', 'sm', 'smf'],
      '2020': ['hs', 'xp', 'xa', 'sm', 'smf'],
      '2021': ['hs', 'xp', 'xa', 'sm', 'smf'],
      '2022': ['hs', 'xp', 'xa', 'sm', 'smf'],
      '2023': ['hs', 'xp', 'xa', 'sm', 'smf'],
      '2024': ['hs', 'xp', 'xa', 'sm', 'smf'],
    },
    'Cooper Clubman JCW': {
      '2009': ['gs', 'xp', 'xa', 'sm', 'smf'],
      '2010': ['gs', 'xp', 'xa', 'sm', 'smf'],
    ...
    'Cooper Clubman S': {
      '2008': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2009': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2010': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2011': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2012': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2013': ['gs', 'xp', 'xb', 'sm', 'smf'],
    ...
    'Cooper Coupe & Roadster (non-S, non-JCW)': {
    ...
    'Cooper Hardtop (Incl. S, 2-door and 4-door F65/F66 chasis)': {
      '2025': ['hs'],
    },
    ...
    'Cooper Hardtop JCW': {
      '2006': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2007': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2008': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2009': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2010': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2011': ['gs', 'xp', 'xb', 'sm', 'smf'],
    ...
    'Cooper Hardtop S': {
      '2002': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2003': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2004': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2005': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2006': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2007': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2008': ['gs', 'xp', 'xb', 'sm', 'smf'],
      '2009': ['gs', 'xp', 'xb', 'sm', 'smf'],
    ...
    'Cooper SE': {
      '2020': ['hs', 'xp', 'xb', 'sm', 'smf', 'evx'],
      '2021': ['hs', 'xp', 'xb', 'sm', 'smf', 'evx'],
      '2022': ['hs', 'xp', 'xb', 'sm', 'smf', 'evx'],
      '2023': ['hs', 'xp', 'xb', 'sm', 'smf', 'evx'],
      '2024': ['hs', 'xp', 'xb', 'sm', 'smf', 'evx'],
    },
    'Countryman JCW All4': {
      '2018': ['gs', 'xp', 'xa', 'sm', 'smf'],
      '2019': ['gs', 'xp', 'xa', 'sm', 'smf'],
  ...
  'Mitsubishi': {
    ...
    'Lancer Ralliart': {
      '2009': ['gs', 'gst', 'xp', 'xa', 'sm'],
      '2010': ['gs', 'gst', 'xp', 'xa', 'sm'],
      '2011': ['gs', 'xp', 'xa', 'sm'],
      '2012': ['gs', 'xp', 'xa', 'sm'],
      '2013': ['gs', 'xp', 'xa', 'sm'],
      '2014': ['gs', 'xp', 'xa', 'sm'],
  ...
  'Pontiac': {
    ...
    'Solstice (non-turbo; non-ZOK)': {
      '2007': ['cs', 'cst', 'dsp', 'dp', 'cams', 'xp', 'ssm'],
      '2008': ['cs', 'cst', 'dsp', 'dp', 'cams', 'xp', 'ssm'],
      '2009': ['cs', 'cst', 'dsp', 'dp', 'cams', 'xp', 'ssm'],
      '2010': ['cs', 'cst', 'dsp', 'dp', 'cams', 'xp', 'ssm'],
    },
    'Solstice (non-turbo; w/ ZOK ClubSport package)': {
      '2007': ['bs', 'cst', 'dsp', 'cams', 'xp', 'ssm'],
      '2008': ['bs', 'cst', 'dsp', 'cams', 'xp', 'ssm'],
      '2009': ['bs', 'cst', 'dsp', 'cams', 'xp', 'ssm'],
      '2010': ['bs', 'cst', 'dsp', 'cams', 'xp', 'ssm'],
    },
    'Solstice GXP': {
      '2007': ['bs', 'ast', 'dsp', 'fp', 'cams', 'xp', 'ssm'],
      '2008': ['bs', 'ast', 'dsp', 'fp', 'cams', 'xp', 'ssm'],
      '2009': ['bs', 'ast', 'dsp', 'fp', 'cams', 'xp', 'ssm'],
    },
    'Sunfire': {
      'all': ['hs', 'xp', 'xa', 'sm', 'smf'],
    },
  ...
  'Porsche': {
    ...
    'Boxster GTS': {
      ...
      '2017': ['as', 'sst', 'xp', 'xu', 'ssm'],
      '2018': ['as', 'sst', 'xp', 'xu', 'ssm'],
      '2019': ['as', 'sst', 'xp', 'xu', 'ssm'],
      '2020': ['as', 'sst', 'xp', 'xu', 'ssm'],
      '2021': ['as', 'sst', 'xp', 'xu', 'ssm'],
      '2022': ['as', 'sst', 'xp', 'xu', 'ssm'],
      '2023': ['as', 'sst', 'xp', 'xu', 'ssm'],
      '2024': ['as', 'sst', 'xp', 'xu', 'ssm'],
    },
    'Boxster S': {
    ...
    'Cayman GTS': {
      ...
      '2017': ['as', 'sst', 'ssp', 'xp', 'xu', 'ssm'],
      '2018': ['as', 'sst', 'ssp', 'xp', 'xu', 'ssm'],
      '2019': ['as', 'sst', 'ssp', 'xp', 'xu', 'ssm'],
      '2020': ['as', 'sst', 'ssp', 'xp', 'xu', 'ssm'],
      '2021': ['as', 'sst', 'ssp', 'xp', 'xu', 'ssm'],
      '2022': ['as', 'sst', 'ssp', 'xp', 'xu', 'ssm'],
      '2023': ['as', 'sst', 'ssp', 'xp', 'xu', 'ssm'],
      '2024': ['as', 'sst', 'ssp', 'xp', 'xu', 'ssm'],
    },
    'Cayman GTS 4.0': {
  ...
  'Saab': {
    ...
    '9-2X Aero (2.0L Turbo)': {
      '2005': ['hs', 'xp', 'xa', 'sm', 'smf'],
      '2006': ['hs', 'xp', 'xa', 'sm', 'smf'],
    },
    '9-2X Linear (2.5L)': {
      'all': ['hs', 'xp', 'xa', 'sm', 'smf'],
    },
  ...
  'Saturn': {
    ...
    'Sky (non-turbo)': {
      '2007': ['cs', 'dst', 'dsp', 'dp', 'cams', 'xp', 'ssm'],
      '2008': ['cs', 'dst', 'dsp', 'dp', 'cams', 'xp', 'ssm'],
      '2009': ['cs', 'dst', 'dsp', 'dp', 'cams', 'xp', 'ssm'],
      '2010': ['cs', 'dst', 'dsp', 'dp', 'cams', 'xp', 'ssm'],
    },
    'Sky Redline (Turbo)': {
      '2007': ['bs', 'ast', 'dsp', 'fp', 'cams', 'xp', 'ssm'],
      '2008': ['bs', 'ast', 'dsp', 'fp', 'cams', 'xp', 'ssm'],
      '2009': ['bs', 'ast', 'dsp', 'fp', 'cams', 'xp', 'ssm'],
      '2010': ['bs', 'ast', 'dsp', 'fp', 'cams', 'xp', 'ssm'],
    },
  },
  'Scion': {
  ...
  'Subaru': {
    'BRZ': {
      ...
      '2022': ['ds', 'cst', 'dsp', 'dp', 'xa', 'sm'],
      '2023': ['ds', 'cst', 'dsp', 'dp', 'xa', 'sm'],
      '2024': ['ds', 'cst', 'dsp', 'dp', 'xa', 'sm'],
      '2025': ['ds', 'cst', 'dsp', 'dp', 'xa', 'sm'],
    },
    'BRZ tS': {
    ...
    'WRX (non-STI, excl. TR, tS)': {
      ...
      '2009': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2010': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2011': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2012': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2013': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2014': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2015': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2016': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2017': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2018': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2019': ['gs', 'gst', 'ssp', 'fp', 'xp', 'xa', 'sm'],
      '2020': ['gs', 'gst', 'fp', 'xp', 'xa', 'sm'],
      '2021': ['gs', 'gst', 'fp', 'xp', 'xa', 'sm'],
      '2022': ['gs', 'gst', 'fp', 'xp', 'xa', 'sm'],
      '2023': ['gs', 'gst', 'fp', 'xp', 'xa', 'sm'],
      '2024': ['gs', 'gst', 'fp', 'xp', 'xa', 'sm'],
      '2025': ['gs', 'gst', 'fp', 'xp', 'xa', 'sm'],
    },
  ...
  'Toyota': {
    ...
    'GR86 (without TRD equipment, excl. 10th Anniv. Edition)': {
      '2022': ['ds', 'cst', 'dsp', 'xp', 'xa', 'sm'],
      '2023': ['ds', 'cst', 'dsp', 'xp', 'xa', 'sm'],
      '2024': ['ds', 'cst', 'dsp', 'xp', 'xa', 'sm'],
      '2025': ['ds', 'cst', 'dsp', 'xp', 'xa', 'sm'],
    },
    ...
    'GR Supra (4-cyl)': {
      '2020': ['cs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2021': ['cs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2022': ['cs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2023': ['cs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2024': ['cs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2025': ['cs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2026': ['cs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
    },
    'GR Supra (6-cyl)': {
      '2020': ['bs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2021': ['bs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2022': ['bs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2023': ['bs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2024': ['bs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2025': ['bs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
      '2026': ['bs', 'sst', 'ssp', 'xp', 'xa', 'ssm'],
    },
  ...
  'Volkswagen': {
    ...
    'Golf GTI': {
      ...
      '2015': ['hs', 'gst', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2016': ['hs', 'gst', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2017': ['hs', 'gst', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2018': ['hs', 'gst', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
    ...
    'Jetta 2.0L Turbo': {
      ...
      '2013': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2014': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2015': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2016': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2017': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2018': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2019': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2020': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2021': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2022': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2023': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2024': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
      '2025': ['hs', 'dsp', 'ep', 'xp', 'xa', 'sm', 'smf'],
    },
    'Jetta TDI': {
