...
const carFlags = {
  ...
  'gt23lCar': [
    ...
    'gt2gt3gtliteSafety',
    'gt2gt3gtliteGeneral',
    'gt2gt3gtliteBodywork',
    'gt2gt3gtliteSuspension',
    'gt2gt3gtliteElectrical',
    'gt2gt3gtliteDrivetrain',
    'gt2gt3gtliteEngine',
    'gt2gt3gtliteRotaryEngine',
    'gt2gt3gtliteTurboBuilt',
    'gt2gt3gtliteTurboOEM',
    'gt2gt3gtliteCooling',
    'gt2gt3gtliteFuelInduction',
    'gt2gt3gtliteBrakes',
    'gt2gt3gtliteGTLWeights',
    'gt2gt3gtliteGT3Weights',
  ],
  'specmiataCar': [
...
function lookupRRCar() { // eslint-disable-line no-unused-vars
  ...
  for (const car of cars) {
    const note = car.notes ? ' <em>(' + car.notes + ')</em>' : '';
    if (car.weight) {
      html += '<p>Your car runs in <strong>' + car.class +
          '</strong> with a minimum competition weight of <strong>' + car.weight +
          ' lbs</strong>' + note + '.</p>';
    } else {
      // GT-2/3/Lite weights are set per-engine, not per-car.
      html += '<p>Your car runs in <strong>' + car.class +
          '</strong> — its minimum weight is set by the engine spec line in the GCR' +
          note + '.</p>';
    }
