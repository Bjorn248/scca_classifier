...
const allSoloCars = {
  ...
  'Chevrolet': {
    ...
    'Corvette Grand Sport': {
      '2017': ['ss', 'ssr', 'ssp', 'camc'],
      '2018': ['ss', 'ssr', 'ssp', 'camc'],
      '2019': ['ss', 'ssr', 'ssp', 'camc'],
    },
    'Corvette Stingray': {
      '2014': ['as', 'ssr', 'ssp', 'camc'],
      '2015': ['as', 'ssp', 'camc'],
      '2016': ['as', 'ssp', 'camc'],
      '2017': ['as', 'ssp', 'camc'],
      '2018': ['as', 'ssp', 'camc'],
    ...
    'Corvette (C6, non-ZR1)': {
      ...
      '2011': ['as', 'ssr', 'ssp', 'camc'],
      '2012': ['as', 'ssr', 'ssp', 'camc'],
      '2013': ['as', 'ssr', 'ssp', 'camc'],
    },
    'Camaro SS 1LE': {
      '1998': ['fs', 'stu', 'camt'],
      '1999': ['fs', 'stu', 'camt'],
    ...
    'Corvette (C5, non-Z06)': {
      '1997': ['bs', 'stu', 'ssp', 'camt'],
      '1998': ['bs', 'stu', 'ssp', 'camt'],
      '1999': ['bs', 'stu', 'ssp', 'camt'],
      '2000': ['bs', 'stu', 'ssp', 'camt'],
      '2001': ['bs', 'stu', 'ssp', 'camc'],
      '2002': ['bs', 'stu', 'ssp', 'camc'],
      '2003': ['bs', 'stu', 'ssp', 'camc'],
      '2004': ['bs', 'stu', 'ssp', 'camc'],
    },
    'Corvette (C4, all, STU excl. LT4 engine & ZR1)': {
      '1984': ['bs', 'stu', 'bsp', 'camt'],
      '1985': ['bs', 'stu', 'bsp', 'camt'],
      '1986': ['bs', 'stu', 'bsp', 'camt'],
      '1987': ['bs', 'stu', 'bsp', 'camt'],
      '1988': ['bs', 'stu', 'bsp', 'camt'],
      '1989': ['bs', 'stu', 'bsp', 'camt'],
      '1990': ['bs', 'stu', 'bsp', 'camt'],
      '1991': ['bs', 'stu', 'bsp', 'camt'],
      '1992': ['bs', 'stu', 'bsp', 'camt'],
      '1993': ['bs', 'stu', 'bsp', 'camt'],
      '1994': ['bs', 'stu', 'bsp', 'camt'],
      '1995': ['bs', 'stu', 'bsp', 'camt'],
      '1996': ['bs', 'stu', 'bsp', 'camt'],
    },
    'Corvette': {
      '1953': ['fs', 'bsp', 'camt'],
      '1954': ['fs', 'bsp', 'camt'],
  ...
  'Mazda': {
    ...
    'Mazdaspeed Miata': {
      '2004': ['es', 'stu', 'bsp', 'fp', 'xsb'],
      '2005': ['es', 'stu', 'bsp', 'fp', 'xsb'],
    },
    'Mazdaspeed Protégé': {
      'all': ['gs', 'sth', 'dsp', 'fp'],
    },
    ...
    'MX-5 Miata': {
      ...
      '1994': ['es', 'str', 'csp', 'dp', 'xsb'],
      '1995': ['es', 'str', 'csp', 'dp', 'xsb'],
      '1996': ['es', 'str', 'csp', 'dp', 'xsb'],
      '1997': ['es', 'str', 'csp', 'dp', 'xsb'],
      '1998': ['es', 'str', 'csp', 'dp', 'xsb'],
      '1999': ['es', 'str', 'csp', 'dp', 'xsb'],
      ...
      '2006': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2007': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2008': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2009': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2010': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2011': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2012': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2013': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2014': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2015': ['cs', 'str', 'csp', 'dp', 'xsb'],
      '2016': ['cs', 'str', 'bsp', 'dp', 'xsb'],
      '2017': ['cs', 'str', 'bsp', 'dp', 'xsb'],
      '2018': ['cs', 'str', 'bsp', 'dp', 'xsb'],
      '2019': ['cs', 'str', 'bsp', 'dp', 'xsb'],
      '2020': ['cs', 'str', 'dp', 'xsb'],
      '2021': ['cs', 'str', 'dp', 'xsb'],
    },
    'MX-5 Miata MS-R': {
