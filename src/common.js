...
const allSoloCars = {
  ...
  'Ford': {
    ...
    'Mustang Boss 302 Laguna Seca': {
      '2012': ['ssr', 'as', 'esp', 'camc', 'sm', 'xp', 'xsa'],
      '2013': ['ssr', 'as', 'esp', 'camc', 'sm', 'xp', 'xsa'],
    },
    'Mustang Boss 302 non-Laguna Seca': {
      '2012': ['fs', 'esp', 'camc', 'sm', 'xp', 'xsa'],
      '2013': ['fs', 'esp', 'camc', 'sm', 'xp', 'xsa'],
    },
    'Mustang Bullitt': {
    ...
    'Mustang GT (w/ Performance Package)': {
      '2018': ['bs', 'esp', 'camc', 'sm', 'xp', 'xsa'],
      '2019': ['bs', 'esp', 'camc', 'sm', 'xp', 'xsa'],
      '2020': ['bs', 'camc', 'sm', 'xp', 'xsa'],
    },
    'Mustang Mach 1': {
    ...
    'Mustang Shelby GT350': {
      '2015': ['ssr', 'bs', 'asp', 'camc', 'sm', 'xp', 'xsa'],
      '2016': ['ssr', 'bs', 'asp', 'camc', 'sm', 'xp', 'xsa'],
      '2017': ['ssr', 'bs', 'camc', 'sm', 'xp', 'xsa'],
      '2018': ['ssr', 'bs', 'camc', 'sm', 'xp', 'xsa'],
      '2019': ['ssr', 'bs', 'camc', 'sm', 'xp', 'xsa'],
      '2020': ['ssr', 'bs', 'camc', 'sm', 'xp', 'xsa'],
    },
    ...
    'Mustang Shelby GT500': {
      '2007': ['as', 'esp', 'camc', 'sm', 'xp', 'xsa'],
      '2008': ['as', 'esp', 'camc', 'sm', 'xp', 'xsa'],
      '2009': ['as', 'esp', 'camc', 'sm', 'xp', 'xsa'],
      '2010': ['as', 'esp', 'camc', 'sm', 'xp', 'xsa'],
      '2011': ['as', 'asp', 'camc', 'sm', 'xp', 'xsa'],
      '2012': ['as', 'asp', 'camc', 'sm', 'xp', 'xsa'],
      '2013': ['as', 'asp', 'camc', 'sm', 'xp', 'xsa'],
      '2014': ['as', 'asp', 'camc', 'sm', 'xp', 'xsa'],
      '2015': ['as', 'camc', 'sm', 'xp', 'xsa'],
    },
    'Mustang V8 (NOC)': {
  ...
  'Honda': {
    ...
    'S2000 (non-CR)': {
      '1999': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2000': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2001': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2002': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2003': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2004': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2005': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2006': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2007': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2008': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2009': ['cs', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
    },
    'S2000 CR': {
      '2008': ['as', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
      '2009': ['as', 'str', 'bsp', 'ssm', 'fp', 'xsa'],
    },
    'del Sol (DOHC)': {
  ...
  'Hyundai': {
    ...
    'Elantra (incl. GT Turbo)': {
      '1990': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '1991': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '1992': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '1993': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '1994': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '1995': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '1996': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '1997': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '1998': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '1999': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '2000': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '2001': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2002': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2003': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2004': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2005': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2006': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2007': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2008': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2009': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2010': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2011': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2012': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2013': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2014': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2015': ['hs', 'sts', 'sm', 'xp', 'xsa', 'smf'],
      '2016': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '2017': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '2018': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '2019': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '2020': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      '2021': ['hs', 'sm', 'xp', 'xsa', 'smf'],
      'all': ['fsp', 'sm', 'sm', 'xp', 'xsa', 'smf'],
    },
    'Excel': {
    ...
    'Veloster Turbo Rally Edition': {
      '2016': ['gs', 'sm', 'xp', 'xsa', 'smf'],
      '2017': ['gs', 'sm', 'xp', 'xsa', 'smf'],
    },
  },
  'Infiniti': {
    'G20': {
  ...
  'Jaguar': {
    ...
    'F-Type (non-Project 7)': {
      '2014': ['as', 'ssr', 'xp', 'xsa', 'sm'],
      '2015': ['as', 'ssr', 'xp', 'xsa', 'sm'],
      '2016': ['as', 'ssr', 'xp', 'xsa', 'sm'],
      '2017': ['as', 'ssr', 'xp', 'xsa', 'sm'],
      '2018': ['as', 'ssr', 'xp', 'xsa', 'sm'],
      '2019': ['as', 'ssr', 'xp', 'xsa', 'sm'],
      '2020': ['as', 'ssr', 'xp', 'xsa', 'sm'],
    },
    'F-Type R & SVR': {
      '2018': ['ss', 'xp', 'xsa', 'sm'],
      '2019': ['ss', 'xp', 'xsa', 'sm'],
  ...
  'Lotus': {
    ...
    'Elise': {
      ...
      '2003': ['fp', 'ssm', 'xp', 'xsb'],
      '2004': ['fp', 'ssm', 'xp', 'xsb'],
      '2005': ['as', 'fp', 'ssm', 'ssp', 'ssr', 'xp', 'xsb'],
      '2006': ['as', 'fp', 'ssm', 'ssp', 'ssr', 'xp', 'xsb'],
      '2007': ['as', 'fp', 'ssm', 'ssp', 'ssr', 'xp', 'xsb'],
      '2008': ['as', 'fp', 'ssm', 'ssp', 'ssr', 'xp', 'xsb'],
      '2009': ['as', 'fp', 'ssm', 'ssp', 'ssr', 'xp', 'xsb'],
      '2010': ['as', 'fp', 'ssm', 'ssp', 'ssr', 'xp', 'xsb'],
      '2011': ['as', 'ssm', 'ssp', 'ssr', 'xp', 'xsb'],
    },
    'Elise SC': {
      '2008': ['ss', 'xp', 'xsb', 'ssm'],
      '2009': ['ss', 'xp', 'xsb', 'ssm'],
    ...
    'Esprit Turbo': {
      '1996': ['as', 'ssp', 'xp', 'xsa', 'ssm'],
      '1997': ['as', 'ssp', 'xp', 'xsa', 'ssm'],
      '1998': ['as', 'ssp', 'xp', 'xsa', 'ssm'],
      '1999': ['as', 'ssp', 'xp', 'xsa', 'ssm'],
      '2000': ['as', 'ssp', 'xp', 'xsa', 'ssm'],
      '2001': ['as', 'ssp', 'xp', 'xsa', 'ssm'],
      '2002': ['as', 'ssp', 'xp', 'xsa', 'ssm'],
      '2003': ['as', 'ssp', 'xp', 'xsa', 'ssm'],
      '2004': ['as', 'ssp', 'xp', 'xsa', 'ssm'],
    },
    'Europa': {
      'all': ['cs', 'dp', 'ssp', 'xp', 'xsb', 'ssm'],
    },
    'Evora': {
      '2010': ['bs', 'ssm', 'ssp', 'xp', 'xsa'],
      '2011': ['bs', 'ssm', 'ssp', 'xp', 'xsa'],
      '2012': ['bs', 'ssm', 'ssp', 'xp', 'xsa'],
      '2013': ['bs', 'ssm', 'ssp', 'xp', 'xsa'],
      '2014': ['bs', 'ssm', 'ssp', 'xp', 'xsa'],
      '2015': ['bs', 'ssm', 'xp', 'xsa'],
    },
    'Evora 400': {
    ...
    'Evora S': {
      '2010': ['ssp', 'xp', 'xsa', 'ssm'],
      '2011': ['as', 'ssp', 'ssr', 'xp', 'xsa', 'ssm'],
      '2012': ['as', 'ssp', 'ssr', 'xp', 'xsa', 'ssm'],
      '2013': ['as', 'ssp', 'ssr', 'xp', 'xsa', 'ssm'],
      '2014': ['as', 'ssp', 'ssr', 'xp', 'xsa', 'ssm'],
  ...
  'Nissan': {
    ...
    'Versa': {
      ...
      '2012': ['hs', 'sts', 'fsp', 'ep', 'xp', 'xsa', 'sm'],
      '2013': ['hs', 'sts', 'fsp', 'ep', 'xp', 'xsa', 'sm'],
      '2014': ['hs', 'fsp', 'ep', 'xp', 'xsa', 'sm'],
      '2015': ['hs', 'fsp', 'ep', 'xp', 'xsa', 'sm'],
      '2016': ['hs', 'fsp', 'xp', 'xsa', 'sm'],
      '2017': ['hs', 'xp', 'xsa', 'sm'],
      '2018': ['hs', 'xp', 'xsa', 'sm'],
      '2019': ['hs', 'xp', 'xsa', 'sm'],
      '2020': ['hs', 'xp', 'xsa', 'sm'],
  ...
  'Porsche': {
    ...
    '911 (non-Turbo)': {
      ...
      '1998': ['as', 'bsp', 'fp', 'xp', 'xsa', 'ssm'],
      '1999': ['as', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2000': ['as', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2001': ['as', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2002': ['as', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2003': ['as', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2004': ['as', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2005': ['as', 'ssr', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2006': ['as', 'ssr', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2007': ['as', 'ssr', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2008': ['as', 'ssr', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2009': ['as', 'ssr', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2010': ['as', 'ssr', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2011': ['as', 'ssr', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
      '2012': ['ss', 'ssr', 'asp', 'fp', 'xp', 'xsa', 'ssm'],
    ...
    'Boxster (non-S)': {
      ...
      '2017': ['as', 'ssr', 'xp', 'xsa', 'ssm'],
      '2018': ['as', 'ssr', 'xp', 'xsa', 'ssm'],
      '2019': ['as', 'ssr', 'xp', 'xsa', 'ssm'],
      '2020': ['as', 'xp', 'xsa', 'ssm'],
      '2021': ['as', 'xp', 'xsa', 'ssm'],
    },
    ...
    'Boxster S': {
      ...
      '2013': ['as', 'ssr', 'asp', 'xp', 'xsa', 'ssm'],
      '2014': ['as', 'ssr', 'asp', 'xp', 'xsa', 'ssm'],
      '2015': ['as', 'ssr', 'asp', 'xp', 'xsa', 'ssm'],
      '2016': ['as', 'ssr', 'asp', 'xp', 'xsa', 'ssm'],
  ...
  'Scion': {
    'FR-S (with TRD suspension; incl. Release Series 1.0 and 2.0)': {
      '2013': ['cs', 'ssc', 'stx', 'csp', 'xp', 'xsa', 'sm'],
      '2014': ['cs', 'ssc', 'stx', 'csp', 'xp', 'xsa', 'sm'],
      '2015': ['cs', 'ssc', 'stx', 'csp', 'xp', 'xsa', 'sm'],
      '2016': ['cs', 'ssc', 'stx', 'csp', 'xp', 'xsa', 'sm'],
    },
    'FR-S (without TRD suspension components)': {
      '2013': ['ds', 'ssc', 'stx', 'csp', 'xp', 'xsa', 'sm'],
      '2014': ['ds', 'ssc', 'stx', 'csp', 'xp', 'xsa', 'sm'],
      '2015': ['ds', 'ssc', 'stx', 'csp', 'xp', 'xsa', 'sm'],
      '2016': ['ds', 'ssc', 'stx', 'csp', 'xp', 'xsa', 'sm'],
    },
    'iA': {
  ...
  'Subaru': {
    'BRZ': {
      '2013': ['ds', 'stx', 'csp', 'dsp', 'ssc', 'xp', 'xsa', 'sm'],
      '2014': ['ds', 'stx', 'csp', 'dsp', 'ssc', 'xp', 'xsa', 'sm'],
      '2015': ['ds', 'ssc', 'stx', 'dsp', 'xp', 'xsa', 'sm'],
      '2016': ['ds', 'ssc', 'stx', 'dsp', 'xp', 'xsa', 'sm'],
      '2017': ['ds', 'stx', 'dsp', 'xp', 'xsa', 'sm'],
      '2018': ['ds', 'stx', 'dsp', 'xp', 'xsa', 'sm'],
      '2019': ['ds', 'stx', 'xp', 'xsa', 'sm'],
      '2020': ['ds', 'stx', 'xp', 'xsa', 'sm'],
    },
    'BRZ tS': {
      '2018': ['cs', 'stx', 'dsp', 'xp', 'xsa', 'sm'],
    },
    'Forester (non-turbo)': {
      'all': ['fsp', 'xp', 'xsa', 'sm'],
    },
  ...
  'Toyota': {
    '86 (with TRD Lowering Springs, TRD Sway Bar Kit, and TRD 17-in. Forged Wheel': {
      '2017': ['cs', 'stx', 'dsp', 'xp', 'xsa', 'sm'],
      '2018': ['cs', 'stx', 'dsp', 'xp', 'xsa', 'sm'],
      '2019': ['cs', 'stx', 'xp', 'xsa', 'sm'],
      '2020': ['cs', 'stx', 'xp', 'xsa', 'sm'],
    },
    ...
    'Supra Turbo': {
      ...
      '1991': ['fs', 'xp', 'xsa', 'sm'],
      '1992': ['fs', 'xp', 'xsa', 'sm'],
      '1993': ['bs', 'asp', 'xp', 'xsa', 'sm'],
      '1994': ['bs', 'asp', 'xp', 'xsa', 'sm'],
      '1995': ['bs', 'asp', 'xp', 'xsa', 'sm'],
      '1996': ['bs', 'asp', 'xp', 'xsa', 'sm'],
      '1997': ['bs', 'asp', 'xp', 'xsa', 'sm'],
      '1998': ['bs', 'asp', 'xp', 'xsa', 'sm'],
  ...
  'Volkswagen': {
    ...
    'Golf GTI': {
      '1975': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1976': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1977': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1978': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1979': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1980': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1981': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1982': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1983': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1984': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1985': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1986': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1987': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1988': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1989': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1990': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1991': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1992': ['hs', 'sts', 'dsp', 'sm', 'ep', 'xp', 'xsb', 'sm', 'smf'],
      '1993': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '1994': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '1995': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '1996': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '1997': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '1998': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '1999': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2000': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2001': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2002': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2003': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2004': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2005': ['hs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2006': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2007': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2008': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2009': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2010': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2011': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2012': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2013': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2014': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2015': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2016': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2017': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2018': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
      '2019': ['gs', 'dsp', 'sm', 'ep', 'xp', 'xsa', 'sm', 'smf'],
    },
    'Golf GTI 1.8L Turbo': {
    ...
    'Passat (2.0L Turbo)': {
      'all': ['gs', 'sth', 'fsp', 'xp', 'xsa', 'sm', 'smf'],
    },
    'Passat (3.6L VR6)': {
      'all': ['gs', 'stx', 'dsp', 'fsp', 'xp', 'xsa', 'sm', 'smf'],
    },
