...
const allSoloCars = {
  ...
  'Aston Martin': {
    'V8 Vantage': {
      ...
      '2018': ['ss', 'sst', 'sm', 'xp', 'xa'],
      '2019': ['ss', 'sst', 'sm', 'xp', 'xa'],
      '2020': ['ss', 'sst', 'sm', 'xp', 'xa'],
      '2021': ['ss', 'sst', 'sm', 'xp', 'xa'],
      '2022': ['ss', 'sst', 'sm', 'xp', 'xa'],
      '2023': ['ss', 'sst', 'sm', 'xp', 'xa'],
    },
  },
  'Audi': {
    '80': {
    ...
    'A4': {
      ...
      '2008': ['gs', 'sth', 'dsp', 'sm', 'xp', 'xa'],
      '2009': ['gs', 'sth', 'dsp', 'sm', 'xp', 'xa'],
      '2010': ['gs', 'sth', 'dsp', 'sm', 'xp', 'xa'],
      '2011': ['gs', 'sth', 'dsp', 'sm', 'xp', 'xa'],
      '2012': ['gs', 'sth', 'dsp', 'sm', 'xp', 'xa'],
    ...
    'S4': {
      '2000': ['ds', 'stu', 'dsp', 'sm', 'xp', 'xa'],
      '2001': ['ds', 'stu', 'dsp', 'sm', 'xp', 'xa'],
      '2002': ['ds', 'stu', 'dsp', 'sm', 'xp', 'xa'],
      '2003': ['ds', 'stu', 'dsp', 'sm', 'xp', 'xa'],
      ...
      '2014': ['ds', 'stu', 'dsp', 'sm', 'xp', 'xa'],
      '2015': ['ds', 'stu', 'dsp', 'sm', 'xp', 'xa'],
    ...
    'TT RS': {
      ...
      '2018': ['ss', 'sst', 'ssp', 'ssm', 'xa', 'xp'],
      '2019': ['ss', 'sst', 'ssp', 'ssm', 'xa', 'xp'],
  ...
  'Ford': {
    ...
    'Mustang Shelby GT350': {
      '2015': ['ssr', 'sst', 'fs', 'esp', 'camc', 'sm', 'xp'],
      '2016': ['ssr', 'sst', 'fs', 'esp', 'camc', 'sm', 'xp'],
      '2017': ['ssr', 'sst', 'fs', 'camc', 'sm', 'xp'],
      '2018': ['ssr', 'sst', 'fs', 'camc', 'sm', 'xp'],
      '2019': ['ssr', 'sst', 'fs', 'camc', 'sm', 'xp'],
      '2020': ['ssr', 'sst', 'fs', 'camc', 'sm', 'xp'],
    },
  ...
  'Mercury': {
    ...
    'Capri (6-cyl)': {
      '1979': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1980': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1981': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1982': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1983': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1984': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1985': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1986': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1987': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1988': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1989': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1990': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1991': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1992': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1993': ['hs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
    },
    'Capri (8-cyl)': {
      ...
      '1991': ['fs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1992': ['fs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
      '1993': ['fs', 'dsp', 'cp', 'camt', 'xp', 'sm'],
    },
    'Capri (non-US)': {
      '1969': ['hs', 'dp', 'xp', 'xa', 'sm'],
      '1970': ['hs', 'dp', 'xp', 'xa', 'sm'],
  ...
  'Nissan': {
    ...
    'GT-R (excluding NISMO & Track Edition)': {
      ...
      '2022': ['ss', 'sst', 'xp', 'xa', 'sm'],
      '2023': ['ss', 'sst', 'xp', 'xa', 'sm'],
    },
  ...
  'Porsche': {
    ...
    '911 (non-Turbo)': {
      ...
      '2012': ['ss', 'sst', 'ssr', 'ssp', 'fp', 'xp', 'xa', 'ssm'],
      '2013': ['ss', 'ssr', 'dsp', 'ssp', 'xp', 'xa', 'ssm'],
      '2014': ['ss', 'ssr', 'dsp', 'ssp', 'xp', 'xa', 'ssm'],
      '2015': ['ss', 'ssr', 'dsp', 'ssp', 'xp', 'xa', 'ssm'],
      '2016': ['ss', 'ssr', 'dsp', 'ssp', 'xp', 'xa', 'ssm'],
      '2017': ['ss', 'ssr', 'dsp', 'ssp', 'xp', 'xa', 'ssm'],
      '2018': ['ss', 'ssr', 'dsp', 'xp', 'xa', 'ssm'],
      '2019': ['ss', 'ssr', 'dsp', 'xp', 'xa', 'ssm'],
      '2020': ['ss', 'dsp', 'xp', 'xa', 'ssm'],
      '2021': ['ss', 'dsp', 'xp', 'xa', 'ssm'],
      '2022': ['ss', 'dsp', 'xp', 'xa', 'ssm'],
    },
    ...
    '911 Turbo': {
      ...
      '1975': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1976': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1977': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1978': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1979': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1980': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1981': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1982': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1983': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1984': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1985': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1986': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1987': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1988': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1989': ['ss', 'ssr', 'ssp', 'xp', 'xa', 'ssm'],
      '1990': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '1991': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '1992': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '1993': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '1994': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '1995': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '1996': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '1997': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '1998': ['ss', 'xp', 'xa', 'ssm'],
      '1999': ['ss', 'xp', 'xa', 'ssm'],
    ...
    'Boxster (non-S)': {
      '1996': ['cs', 'str', 'dsp', 'fp', 'xp', 'xa', 'ssm'],
      '1997': ['cs', 'str', 'dsp', 'fp', 'xp', 'xa', 'ssm'],
      '1998': ['cs', 'str', 'ssr', 'dsp', 'fp', 'xp', 'xa', 'ssm'],
      '1999': ['cs', 'str', 'ssr', 'dsp', 'fp', 'xp', 'xa', 'ssm'],
      ...
      '2005': ['bs', 'str', 'ssr', 'ssp', 'fp', 'xp', 'xa', 'ssm'],
      '2006': ['bs', 'str', 'ssr', 'ssp', 'fp', 'xp', 'xa', 'ssm'],
      '2007': ['bs', 'str', 'ssr', 'ssp', 'fp', 'xp', 'xa', 'ssm'],
      '2008': ['bs', 'str', 'ssr', 'ssp', 'fp', 'xp', 'xa', 'ssm'],
    ...
    'Cayman (non-S)': {
      '2006': ['bs', 'ssr', 'str', 'ssp', 'fp', 'xp', 'xa', 'ssm'],
      '2007': ['bs', 'ssr', 'str', 'ssp', 'fp', 'xp', 'xa', 'ssm'],
      '2008': ['bs', 'ssr', 'str', 'ssp', 'fp', 'xp', 'xa', 'ssm'],
    ...
    'Cayman GTS & GTS 4.0 & Spyder': {
      ...
      '2018': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '2019': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '2020': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '2021': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '2022': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
      '2023': ['ss', 'ssp', 'xp', 'xa', 'ssm'],
    },
    'Cayman R': {
      '2012': ['ss', 'ssp', 'fp', 'xp', 'xa', 'sm'],
    },
    'Cayman S': {
  ...
  'Tesla': {
    'Model 3': {
      '2018': ['ss', 'ssp', 'xp', 'xa', 'sm', 'evx'],
      '2019': ['ss', 'ssp', 'xp', 'xa', 'sm', 'evx'],
      '2020': ['ss', 'ssp', 'xp', 'xa', 'sm', 'evx'],
      '2021': ['ss', 'ssp', 'xp', 'xa', 'sm', 'evx'],
      '2022': ['ss', 'ssp', 'xp', 'xa', 'sm', 'evx'],
      '2023': ['ss', 'ssp', 'xp', 'xa', 'sm', 'evx'],
    },
    'Model S': {
