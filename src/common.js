...
const allSoloCars = {
  ...
  'BMW': {
    ...
    'M3': {
      ...
      '2007': ['fs', 'esp', 'ssp', 'sm', 'xa', 'xp'],
      '2008': ['fs', 'esp', 'ssp', 'sm', 'xa', 'xp'],
      '2009': ['fs', 'esp', 'ssp', 'sm', 'xa', 'xp'],
      '2010': ['fs', 'esp', 'ssp', 'sm', 'xa', 'xp'],
      '2011': ['fs', 'esp', 'ssp', 'sm', 'xa', 'xp'],
      '2012': ['fs', 'esp', 'ssp', 'sm', 'xa', 'xp'],
      '2013': ['fs', 'esp', 'ssp', 'sm', 'xa', 'xp'],
  ...
  'Toyota': {
    ...
    'Supra Turbo': {
      ...
      '2020': ['bs', 'sst', 'xp', 'xa', 'sm'],
      '2021': ['bs', 'sst', 'xp', 'xa', 'sm'],
      '2022': ['bs', 'sst', 'xp', 'xa', 'sm'],
    },
    'Tacoma': {
