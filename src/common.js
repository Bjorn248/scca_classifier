...
const allSoloCars = {
  ...
  'Subaru': {
    ...
    'Legacy 2.5GT': {
      '2005': ['hs', 'gst', 'ssp', 'esp', 'xp', 'xa', 'sm'],
      '2006': ['hs', 'gst', 'ssp', 'esp', 'xp', 'xa', 'sm'],
      '2007': ['hs', 'gst', 'ssp', 'esp', 'xp', 'xa', 'sm'],
      '2008': ['hs', 'gst', 'ssp', 'esp', 'xp', 'xa', 'sm'],
      '2009': ['hs', 'gst', 'ssp', 'esp', 'xp', 'xa', 'sm'],
      '2010': ['hs', 'gst', 'ssp', 'esp', 'xp', 'xa', 'sm'],
      '2011': ['hs', 'gst', 'ssp', 'esp', 'xp', 'xa', 'sm'],
      '2012': ['hs', 'gst', 'ssp', 'esp', 'xp', 'xa', 'sm'],
    },
    'Legacy (6-cyl, all)': {
      '1998': ['dsp', 'xp', 'xa', 'sm'],
      '1999': ['dsp', 'xp', 'xa', 'sm'],
