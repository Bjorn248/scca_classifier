...
const allSoloCars = {
  ...
  'BMW': {
    ...
    '135i': {
      '2008': ['fs', 'stu', 'asp', 'sm', 'fp', 'xp', 'xa'],
      '2009': ['fs', 'stu', 'asp', 'sm', 'fp', 'xp', 'xa'],
      '2010': ['fs', 'stu', 'asp', 'sm', 'fp', 'xp', 'xa'],
      '2011': ['fs', 'stu', 'asp', 'sm', 'xp', 'xa'],
      '2012': ['fs', 'stu', 'asp', 'sm', 'xp', 'xa'],
      '2013': ['fs', 'stu', 'asp', 'sm', 'xp', 'xa'],
    },
    '135is': {
    ...
    'M2 (except Performance Edition ZL9)': {
      '2016': ['bs', 'sst', 'asp', 'sm', 'xa', 'xp'],
      '2017': ['bs', 'sst', 'asp', 'sm', 'xa', 'xp'],
      '2018': ['bs', 'sst', 'asp', 'sm', 'xa', 'xp'],
      '2019': ['bs', 'sst', 'asp', 'sm', 'xa', 'xp'],
      '2020': ['bs', 'asp', 'sm', 'xa', 'xp'],
    },
    'M2 CS': {
    ...
    'M235i': {
      '2014': ['fs', 'stu', 'asp', 'sm', 'xp', 'xa'],
      '2015': ['fs', 'stu', 'asp', 'sm', 'xp', 'xa'],
      '2016': ['fs', 'stu', 'asp', 'sm', 'xp', 'xa'],
    },
    'M240i (incl. xDrive)': {
    ...
    'Z4 Coupe & Roadster (non-M)': {
      ...
      '2021': ['as', 'str', 'bsp', 'sm', 'fp', 'xp', 'xa'],
      '2022': ['as', 'str', 'bsp', 'sm', 'fp', 'xp', 'xa'],
    },
    'Z4 M Coupe & Roadster': {
  ...
  'Chevrolet': {
    ...
    'Camaro ZL1 (non-1LE)': {
      '2012': ['as', 'sst', 'ssr', 'asp', 'camc', 'xp', 'xa', 'sm'],
      '2013': ['as', 'sst', 'ssr', 'asp', 'camc', 'xp', 'xa', 'sm'],
      '2014': ['as', 'sst', 'ssr', 'camc', 'xp', 'xa', 'sm'],
      '2015': ['as', 'sst', 'ssr', 'camc', 'xp', 'xa', 'sm'],
      '2017': ['as', 'sst', 'ssr', 'asp', 'camc', 'xp', 'xa', 'sm'],
      '2018': ['as', 'sst', 'ssr', 'asp', 'camc', 'xp', 'xa', 'sm'],
      '2019': ['as', 'sst', 'ssr', 'asp', 'camc', 'xp', 'xa', 'sm'],
  ...
  'Pontiac': {
    ...
    'Solstice GXP (Turbo)': {
      '2007': ['as', 'asp', 'fp', 'cams', 'xp', 'xa', 'ssm'],
      '2008': ['as', 'asp', 'fp', 'cams', 'xp', 'xa', 'ssm'],
      '2009': ['as', 'asp', 'fp', 'cams', 'xp', 'xa', 'ssm'],
    },
    'Sunfire': {
      'all': ['hs', 'xp', 'xa', 'sm', 'smf'],
    },
  ...
  'Porsche': {
    ...
    '911 (non-Turbo)': {
      ...
      '1989': ['cs', 'str', 'bsp', 'fp', 'xp', 'xa', 'ssm'],
      '1990': ['cs', 'bsp', 'fp', 'xp', 'xa', 'ssm'],
      '1991': ['cs', 'bsp', 'fp', 'xp', 'xa', 'ssm'],
      '1992': ['cs', 'bsp', 'fp', 'xp', 'xa', 'ssm'],
      '1993': ['cs', 'bsp', 'fp', 'xp', 'xa', 'ssm'],
      '1994': ['cs', 'bsp', 'fp', 'xp', 'xa', 'ssm'],
      '1995': ['bs', 'bsp', 'fp', 'xp', 'xa', 'ssm'],
      '1996': ['bs', 'bsp', 'fp', 'xp', 'xa', 'ssm'],
      '1997': ['bs', 'bsp', 'fp', 'xp', 'xa', 'ssm'],
