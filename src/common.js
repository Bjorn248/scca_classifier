...
const allSoloCars = {
  ...
  'Toyota': {
    ...
    'GR Supra (4-cyl)': {
      '2020': ['cs', 'sst', 'xp', 'xa', 'sm'],
      '2021': ['cs', 'sst', 'xp', 'xa', 'sm'],
      '2022': ['cs', 'sst', 'xp', 'xa', 'sm'],
      '2023': ['cs', 'sst', 'xp', 'xa', 'sm'],
      '2024': ['cs', 'sst', 'xp', 'xa', 'sm'],
      '2025': ['cs', 'sst', 'xp', 'xa', 'sm'],
    },
    'GR Supra (6-cyl)': {
      '2020': ['bs', 'sst', 'xp', 'xa', 'sm'],
      '2021': ['bs', 'sst', 'xp', 'xa', 'sm'],
      '2022': ['bs', 'sst', 'xp', 'xa', 'sm'],
      '2023': ['bs', 'sst', 'xp', 'xa', 'sm'],
      '2024': ['bs', 'sst', 'xp', 'xa', 'sm'],
      '2025': ['bs', 'sst', 'xp', 'xa', 'sm'],
    },
    'Tacoma': {
